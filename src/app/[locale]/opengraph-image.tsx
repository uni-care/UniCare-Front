...
export const alt = "UniCare - The Universities Ecosystem of Care";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            {isAr ? "منظومة الرعاية الجامعية" : "The Universities Ecosystem of Care"}
          </h1>
          ...
          >
            {isAr
              ? "متجر جامعي لإعارة وشراء ومشاركة الكتب المنهجية وأدوات المختبرات والمستلزمات بين مجتمع الجامعة."
              : "A campus marketplace to lend, buy, and share textbooks, lab tools, and resources across the university community."}
          </p>
        </div>
