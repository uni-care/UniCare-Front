...
export const alt = "UniCare Campus Marketplace";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            {isAr ? "المتجر الطلابي" : "Campus Marketplace"}
          </h1>
          ...
          >
            {isAr
              ? "ابحث عن الكتب المنهجية، لوحات الرسم، مستلزمات المختبرات، الآلات الحاسبة، ومختلف الاحتياجات الجامعية التي يشاركها الطلاب."
              : "Find textbooks, drawing boards, lab equipment, calculators, and other academic assets shared by fellow students."}
          </p>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: "14px", color: "#9CA3AF" }}>
            uni-care-front.vercel.app/marketplace
          </span>
        </div>
      </div>
    ),
