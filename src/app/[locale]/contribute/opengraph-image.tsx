...
export const alt = "Contribute to UniCare - Grow the Circle of Care";
export const size = {
  width: 1200,
  height: 630,
};
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            {isAr ? "العطاء رعاية متبادلة" : "SHARING IS CARING"}
          </div>
          ...
          >
            {isAr ? "لِنتشارك الدعم والرعاية" : "Grow the Circle of Care"}
          </h1>
          ...
          >
            {isAr
              ? "منصة UniCare هي نظام بيئي يديره مجتمع الطلاب. هناك طرق عديدة لدعم رسالتنا — سواء بالمشاركة أو البرمجة أو التطوير."
              : "UniCare is a community-driven ecosystem. Join us to support our mission—whether by sharing, building features, or sponsoring resources."}
          </p>
        </div>
        ...
        >
          ...
          <span style={{ fontSize: "14px", color: "#9CA3AF" }}>
            uni-care-front.vercel.app/contribute
          </span>
        </div>
      </div>
    ),
